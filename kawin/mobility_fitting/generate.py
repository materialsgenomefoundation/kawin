...
def setup_mobility_fitting_description(elements, fit_to_tracer = False):
    '''
    Create custom classes for diffusion prefactor, activation energy and tracer diffusivity
...
def fit_mobility(input_settings, fit_to_tracer=False, tdb_save_params = {}):
    ...
    aliases = add_mobility_keywords(components)
    setup_mobility_fitting_description(components, fit_to_tracer=fit_to_tracer)
