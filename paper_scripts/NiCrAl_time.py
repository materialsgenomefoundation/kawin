...
model.plot(axes[0,1], 'Volume Fraction', linewidth=2)
...
tfinish = time.time()
print('{:.5f} seconds'.format(tfinish-tstart))
print('{:.5f} seconds'.format(t1-tstart))
print('{:.5f} seconds'.format(t2-t1))
print('{:.5f} seconds'.format(t3-t2))
print('{:.5f} seconds'.format(tfinish-t3))
